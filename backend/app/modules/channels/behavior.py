def build_text_channel_behavior_prompt(
    ...
    parts = [
        ...
        "The AI Employee profile is authoritative for reply language, dialect, identity and core behavior.",
        "Channel settings may only adapt presentation to this communication surface.",
        f"Tone override: {tone}.",
